...
<div style="margin-bottom: 12px;background: #d7ebf7;padding: 8px;">
	<p style="font-size:12px;margin-bottom:4px"><?=$obj_name?></p>
	<p style="font-size:12px;margin:0px">ID[<?=$obj_id?>] NodeID[<?=$tree_id?>]</p>
</div>

<form action="/admin/admin-page/ajax_update_node" method="post" enctype="multipart/form-data" class="page-editor">
...
<h2><?= app_lang('ADMP_FORM_TITLE_TPL') ?></h2>
	...
	?>
   <div class="form-group" style="flex-basis:100%;display:none">
