...
<h2>Изменение родилей через CSV</h2>

<p>Для того, чтобы добавить ноды для объекта, создайте файл CSV и создайте в нем поля: <strong>obj_id</strong> и <strong>tree_parent_id</strong>. В  <strong>obj_id</strong> укажите
	<strong>ID объекта</strong>, а в <strong>tree_parent_id</strong> перечислите новые родительские ноды через вертикальную черту (123 | 525| 652). <strong>ВАЖНО! Такой способ создает новые ноды, но не удаляет старые!</strong></p>
