...
/*
	...
	*
	* 4.4
	* Совместимость с плагином экспорта версии 10+
	*
	* 4.5
	* Добавлена возможность сортировки вложенных нод. Переименование плагина в Структура сайта
	*
	* 4.51
	* Выведена иконка часов для запланированных страниц
	*
	* 4.52
	* Добавлена функция обновления ноды
	*
	* 4.6
	* переделано редактирование во всплывающем окне. Плагин admin_page должен быть версии 6.3+
	*
	* 4.61
	* Исправлена ошибка при отправки формы терялось содержимое тектовых редакторов
	*
	* 4.62
	* Интеграция с chosen
	*
