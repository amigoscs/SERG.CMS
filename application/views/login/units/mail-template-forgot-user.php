...
?>
<p>Вы запросили изменение пароля на сайте <a href="<?= $site_url ?>" title="Перейти на сайт"><?= $site_name ?></a></p>
<p>Для того, чтобы изменить пароль, перейдите по ссылке <a href="<?= $site_url ?>/login/forgot?me=1&user=<?= $users_id ?>&confirmkey=<?= $users_activate_key ?>" title="Перейти на сайт">ссылке</a></p>
<p><strong>Внимание! Если вы не запрашивали изменение пароля, то удалите!</strong></p>
